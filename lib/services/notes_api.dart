...
class NoteApiService {
  ...
  Future<Note?> fetchCreateNote({required String? accessToken, required Note? note}) async {
    try {
      Response response =
          await _dio.post(
            '${_baseUrl}users/notes/',
  ...
  Future<bool> fetchUpdateNote({required String? accessToken, required String? id, required Note? note}) async {
    try {
      Response response =
          await _dio.put(
            '${_baseUrl}users/notes/',
  ...
  Future<bool> fetchDeleteNote({required String? accessToken, required String? id}) async {
    try {
  ...
  Future<MyTab?> fetchCreateTab({required String? accessToken, required MyTab newTabData}) async {
    try {
      Response response =
      await _dio.post(
          '${_baseUrl}users/tabs/',
  ...
  Future<bool> fetchUpdateTab({required String? accessToken, required String? id, required MyTab? updateTabData}) async {
    try {
      Response response =
      await _dio.put(
        '${_baseUrl}users/tabs/',
  ...
  Future<bool> fetchDeleteTab({required String? accessToken, required String? id}) async {
    try {
      Response response =
      await _dio.post(
          '${_baseUrl}users/tabs/',
